 ...
 * @category Workspace
 */
export type { Generator, GeneratorCallback, Executor, ExecutorContext, TaskGraphExecutor, GeneratorsJson, ExecutorsJson, MigrationsJson, } from 'nx/src/config/misc-interfaces';
/**
 * @category Workspace
 */
